...
remain documented in [the T3 client/server contract](../internals/client-server-contract.md);
...
- `docs/internals/client-server-contract.md` — exhaustive wire-contract index and
