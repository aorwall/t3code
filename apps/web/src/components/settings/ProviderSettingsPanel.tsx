  ...
  return (
    <>
      <SettingsSection
        ...
        headerAction={
          // Fork: the provider list is a read every server serves; configuring
          // an instance is not, so only this affordance is gated behind server
          // administration.
          !readOnly && FEATURES.serverAdministration ? (
            <Button
              size="compact"
              variant="outline"
