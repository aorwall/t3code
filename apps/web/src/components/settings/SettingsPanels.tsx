  ...
  return (
    <SettingsPageContainer>
      ...
      <SettingsSection id="organization" title="Organization">
        {/* Fork: this build runs a single environment, so there is nothing to
            group repositories across. */}
      ...
      <SettingsSection id="behavior" title="Behavior">
        ...
        <SettingsRow
          ...
          description="Open linked pull requests first. Otherwise, open the working tree diff for changes to at least 3 files or 50 lines. Also opens the browser when something opens a tab on this thread."
          resetAction={
            settings.proactivePanelsEnabled !== DEFAULT_UNIFIED_SETTINGS.proactivePanelsEnabled ? (
              <SettingResetButton
      ...
      <SettingsSection id="projects-and-threads" title="Projects & threads">
        ...
        {/* Fork: the Moatless backend doesn't support server-managed project
            directories or the Add Project browser. */}
      ...
      <SettingsSection id="confirmations" title="Confirmations">
        ...
        {/* Fork: archiving (closing the Moatless task) keeps the conversation
            and its history, so there is no destructive delete to confirm. */}
    ...
    async (threadRef: ScopedThreadRef, position: { x: number; y: number }) => {
      ...
      const clicked = await api.contextMenu.show(
        [
          ...
          // Fork: see the threadDeletion feature flag comment above.
          ...(FEATURES.threadDeletion
