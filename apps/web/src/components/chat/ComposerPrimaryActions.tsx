...
export const ComposerPrimaryActions = memo(function ComposerPrimaryActions({
  ...
  // Fork: while a turn is running the primary action stays Stop only when the
  // composer is empty; typed content switches it back to Send so a follow-up
  // can be queued without interrupting the run.
