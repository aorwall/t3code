...
// Fork: Moatless owns project creation, and the thread list is a browse over
// someone else's work as often as it is over your own.
      ...
      <div className="flex shrink-0 items-center rounded-md bg-sidebar-control-surface/60 p-px">
        {hasProjects ? (
          <>
            ...
            {/* Fork: who the listed threads belong to, and whether closed ones
                are among them. */}
            <SidebarThreadFilter />
          </>
        ) : null}
