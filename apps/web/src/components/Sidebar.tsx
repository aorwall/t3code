  ...
  const {
    ...
    for (const thread of visible) {
      ...
      if (optimisticDrop?.key === threadKey) {
        ...
        // Fork: a pinned thread never auto-settles — check pin before
        // settlement, reversing upstream's order. Settlement is Moatless's to
        // decide (see docs/fork/gaps.md, "Settlement rules Moatless owns").
        pinned.push(thread);
