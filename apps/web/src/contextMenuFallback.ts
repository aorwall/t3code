...
export function showContextMenuFallback<T extends string>(
  ...
  return new Promise<T | null>((resolve) => {
    ...
    const openMenu = (
      ...
      menu.style.cssText =
        "position:fixed;z-index:10000;min-width:8rem;max-width:min(24rem,calc(100vw - 0.5rem));overflow:hidden;border-radius:var(--radius-lg);background-clip:padding-box;color:var(--contrast-popover-foreground);outline:none;pointer-events:auto;";
