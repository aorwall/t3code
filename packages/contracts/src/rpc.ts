...
const WsServerUpdateServerWithProgressRpc = Rpc.make(WS_METHODS.serverUpdateServerWithProgress, {
  ...
  // Fork: Moatless does not dispatch server.updateServerWithProgress, like its
  // sibling server-update methods. See gaps.md.
  error: Schema.Union([
    ServerSelfUpdateError,
    EnvironmentAuthorizationError,
    UnsupportedMethodError,
...
const WsServerCommitDesktopUpdateRpc = Rpc.make(WS_METHODS.serverCommitDesktopUpdate, {
  ...
  success: ServerSelfUpdateResult,
  // Fork: Moatless does not dispatch server.commitDesktopUpdate — like its
  // sibling server-update methods, it needs UnsupportedMethodError so the
  // client decodes the refusal instead of an unexpected server error. See
  // "Desktop and host lifecycle" in docs/fork/gaps.md.
  error: Schema.Union([
    ServerSelfUpdateError,
    EnvironmentAuthorizationError,
    UnsupportedMethodError,
...
const WsServerUpdateSettingsRpc = Rpc.make(WS_METHODS.serverUpdateSettings, {
  ...
  success: ServerSettings,
  error: Schema.Union([ServerSettingsError, EnvironmentAuthorizationError, UnsupportedMethodError]),
});
...
const WsServerGetProcessResourceHistoryRpc = Rpc.make(WS_METHODS.serverGetProcessResourceHistory, {
  ...
  // Fork: Moatless does not dispatch server.getProcessResourceHistory. See gaps.md.
  error: Schema.Union([EnvironmentAuthorizationError, UnsupportedMethodError]),
});
...
const WsPullRequestsSubscribeRefreshesRpc = Rpc.make(WS_METHODS.pullRequestsSubscribeRefreshes, {
  ...
  // Fork: Moatless does not dispatch this method. See docs/fork/gaps.md.
  error: Schema.Union([EnvironmentAuthorizationError, UnsupportedMethodError]),
  stream: true,
});
...
const WsSourceControlLookupRepositoryRpc = Rpc.make(WS_METHODS.sourceControlLookupRepository, {
  ...
  // Fork: Moatless does not dispatch sourceControl.lookupRepository. See gaps.md.
  error: Schema.Union([
    SourceControlRepositoryError,
    EnvironmentAuthorizationError,
    UnsupportedMethodError,
...
const WsSourceControlPublishRepositoryRpc = Rpc.make(WS_METHODS.sourceControlPublishRepository, {
  ...
  // Fork: Moatless does not dispatch sourceControl.publishRepository. See gaps.md.
  error: Schema.Union([
    SourceControlRepositoryError,
    EnvironmentAuthorizationError,
    UnsupportedMethodError,
...
const WsVcsPullRpc = Rpc.make(WS_METHODS.vcsPull, {
  ...
  error: Schema.Union([GitCommandError, EnvironmentAuthorizationError, UnsupportedMethodError]),
});
...
const WsVcsInitRpc = Rpc.make(WS_METHODS.vcsInit, {
  ...
  error: Schema.Union([VcsError, EnvironmentAuthorizationError, UnsupportedMethodError]),
});
...
const WsSubscribeDiscoveredLocalServersRpc = Rpc.make(WS_METHODS.subscribeDiscoveredLocalServers, {
  ...
  // Fork: Moatless does not dispatch subscribeDiscoveredLocalServers. See gaps.md.
  error: Schema.Union([EnvironmentAuthorizationError, UnsupportedMethodError]),
  stream: true,
});

// Fork: Moatless dispatches none of the device.* methods. See gaps.md.
const WsDeviceTestHostRpc = Rpc.make(WS_METHODS.deviceTestHost, {
  payload: SshDeviceHostConfig,
  success: DeviceHostSummary,
  error: Schema.Union([DeviceError, EnvironmentAuthorizationError, UnsupportedMethodError]),
});
...
const WsSubscribeDeviceStateRpc = Rpc.make(WS_METHODS.subscribeDeviceState, {
  payload: Schema.Struct({}),
  success: DeviceServiceState,
  // Fork: Moatless does not dispatch subscribeDeviceState. See gaps.md.
  error: Schema.Union([EnvironmentAuthorizationError, UnsupportedMethodError]),
  stream: true,
});
...
const WsOrchestrationGetWorkflowScriptRpc = Rpc.make(ORCHESTRATION_WS_METHODS.getWorkflowScript, {
  ...
  // Fork: Moatless does not dispatch orchestration.getWorkflowScript. See gaps.md.
  error: Schema.Union([
    OrchestrationGetWorkflowScriptError,
    EnvironmentAuthorizationError,
    UnsupportedMethodError,
...
const WsOrchestrationGetFullThreadDiffRpc = Rpc.make(ORCHESTRATION_WS_METHODS.getFullThreadDiff, {
  ...
  // Fork: Moatless does not dispatch orchestration.getFullThreadDiff. See gaps.md.
  error: Schema.Union([
    OrchestrationGetFullThreadDiffError,
    EnvironmentAuthorizationError,
    UnsupportedMethodError,
