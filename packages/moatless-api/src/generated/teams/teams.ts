 ...
 */
export const listTeams = async ( options?: Parameters<typeof customInstance>[1]): Promise<listTeamsResponse> => {
 ...
 */
export const createTeam = async (createTeamRequest: CreateTeamRequest, options?: Parameters<typeof customInstance>[1]): Promise<createTeamResponse> => {
 ...
 */
export const getTeam = async (teamId: string, options?: Parameters<typeof customInstance>[1]): Promise<getTeamResponse> => {
...
export const updateTeam = async (teamId: string,
    updateTeamRequest: UpdateTeamRequest, options?: Parameters<typeof customInstance>[1]): Promise<updateTeamResponse> => {
 ...
 */
export const deleteTeam = async (teamId: string, options?: Parameters<typeof customInstance>[1]): Promise<deleteTeamResponse> => {
 ...
 */
export const listMembers = async (teamId: string, options?: Parameters<typeof customInstance>[1]): Promise<listMembersResponse> => {
 ...
 */
export const addMember = async (teamId: string,
    addTeamMemberRequest: AddTeamMemberRequest, options?: Parameters<typeof customInstance>[1]): Promise<addMemberResponse> => {
...
export const getRemoveMemberUrl = (teamId: string,
    userId: string,) => {
 ...
 */
export const removeMember = async (teamId: string,
    userId: string, options?: Parameters<typeof customInstance>[1]): Promise<removeMemberResponse> => {
