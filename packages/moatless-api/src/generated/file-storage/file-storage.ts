 ...
 */
export const uploadFile = async (uploadFileBody: UploadFileBody, options?: Parameters<typeof customInstance>[1]): Promise<uploadFileResponse> => {
 ...
 */
export const downloadFile = async (fileId: string, options?: Parameters<typeof customInstance>[1]): Promise<downloadFileResponse> => {
